...
@Injectable()
export class CreateAccountUnitOfWork extends UnitOfWork {
  constructor(
  ...
  async run({ account, goal, profile }: CreateAccountUnitOfWork.RunParams) {
...
export namespace CreateAccountUnitOfWork {
