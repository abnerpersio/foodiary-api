...
const schema = z.object({
  ...
  mealsBucketName: z.string(),
  accountsBucketName: z.string(),
  mealsCdnDomainName: z.string(),
  mealsQueueUrl: z.string(),
...
const { error, data } = schema.safeParse({
  ...
  mealsBucketName: process.env.MEALS_STORAGE_BUCKET_NAME || "",
  accountsBucketName: process.env.ACCOUNTS_STORAGE_BUCKET_NAME || "",
  mealsCdnDomainName: process.env.CDN_DOMAIN_NAME || "",
  mealsQueueUrl: process.env.MEALS_QUEUE_URL || "",
